...
export const adminAPI = {
  ...
  listPagamentosPendentes: () => api.get('/admin/pagamentos/pendentes'),
  confirmarPagamentoAdmin: (id) => api.post(`/admin/pagamentos/${id}/confirmar`),
  rejeitarPagamentoAdmin: (id) => api.delete(`/admin/pagamentos/${id}`),
